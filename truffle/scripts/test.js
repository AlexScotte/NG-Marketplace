...
module.exports = async (deployer, network) => {
    ...
    await treasureGuardianInstance.safeTransferFrom(treasureGuardianInstance.address, a2, 1100, 10, []);
    console.log((await guardianStuff.balanceOf(treasureGuardianInstance.address, 1100)).toNumber());
    console.log((await guardianStuff.balanceOf(a2, 1100)).toNumber());
    ...
    await auctionHouseInstance.listItem(1100, web3.utils.toWei('1', 'ether'), 11, { from: a2, value: listingFee });
    console.log((await guardianStuff.balanceOf(a2, 1100)).toNumber());
