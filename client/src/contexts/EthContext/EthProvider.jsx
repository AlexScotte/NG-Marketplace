    ...
    if (userConnected) {
      ...
      if (loadingArtifactsOK) {
        ...
        const deployTransaction = await web3.eth.getTransaction(
          treasureGuardianArtifact.networks[networkID].transactionHash
        );
        ...
        try {
          ...
          treasureGuardianAddress =
            treasureGuardianArtifact.networks[networkID].address;
          console.log("Treasure guardian address: " + treasureGuardianAddress);
          treasureGuardianContract = new web3.eth.Contract(
            treasureGuardianArtifact.abi,
            treasureGuardianAddress
          );

          // Guardian Stuff contract
          const guardianStuffAddress = await treasureGuardianContract.methods
            .guardianStuff()
            .call();
          guardianStuffContract = new web3.eth.Contract(
          ...
          const guardianTokenAddress = await treasureGuardianContract.methods
            .guardianToken()
            .call();
          guardianTokenContract = new web3.eth.Contract(
            guardianTokenArtifact.abi,
            guardianTokenAddress
          );
          guardianTokenDecimals = await guardianTokenContract.methods
            .decimals()
            .call();
          ...
          auctionHouseAddress =
            auctionHouseArtifact.networks[networkID].address;
          auctionHouseContract = new web3.eth.Contract(
